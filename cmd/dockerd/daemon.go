...
import (
	...
	"github.com/rancher/betsy/api/server/router/build"
	"github.com/rancher/betsy/api/server/router/container"
	"github.com/rancher/betsy/api/server/router/image"
	systemrouter "github.com/rancher/betsy/api/server/router/system"
	"github.com/rancher/betsy/api/server/router/volume"
	"github.com/rancher/betsy/daemon"
...
func (cli *DaemonCli) start(opts daemonOptions) (err error) {
	...
	for i := 0; i < len(cli.Config.Hosts); i++ {
		var err error
		if cli.Config.Hosts[i], err = dopts.ParseHost(false, cli.Config.Hosts[i]); err != nil {
		...
		ls, err := listeners.Init(proto, addr, serverConfig.SocketGroup, nil)
		if err != nil {
			return err
		}
